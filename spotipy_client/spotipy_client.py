...
class SpotipyClient():
    ...
    def content_based_filtering(self, pos, cos_sim, ncands, umbral = 0.8):
        ...
        idx = idx[np.argsort(cos_sim[pos,idx])[::-1]] #[::-1]
    ...
    def create_recommended_playlist(self):
        ...
        pl = self.client.user_playlist_create(user = self.username,
            ...
            description = 'This playlist was created using a recommender system developed by @juanjo9915 using Spotify API and Spotipy')
